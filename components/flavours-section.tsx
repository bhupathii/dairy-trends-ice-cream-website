...
export default function FlavoursSection() {
  ...
  return (
    <section id="flavours" className="relative py-20 lg:py-28 overflow-hidden bg-cream">
      {/* Background Decoration */}
      <div className="absolute top-0 left-0 w-full h-32 bg-gradient-to-b from-pink/20 to-transparent" />
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-golden/10 rounded-full blur-3xl -translate-y-1/2" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" ref={ref}>
                ...
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity translate-y-4 group-hover:translate-y-0 duration-300">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.9 }}
                      className="flex-1 bg-brand-red text-white py-2 rounded-full text-sm font-semibold flex items-center justify-center gap-1"
                    >
                    ...
                    <motion.button
                      whileHover={{ scale: 1.1 }}
                      whileTap={{ scale: 0.9 }}
                      className="bg-white/90 text-chocolate p-2 rounded-full"
                    >
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <motion.button
                        whileTap={{ scale: 0.9 }}
                        className="bg-brand-red text-white px-4 py-1.5 rounded-full text-sm font-semibold flex items-center gap-1"
                      >
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="bg-chocolate text-white px-8 py-3 rounded-full font-semibold shadow-lg hover:shadow-xl transition-shadow"
          >
            View All Flavours
          </motion.button>
        </motion.div>
